    ...
    <main className="min-h-screen p-6 md:p-12 w-full max-w-7xl mx-auto flex flex-col gap-12 overflow-x-hidden pt-24 md:pt-32 pb-24">
      ...
      <section className="flex flex-col gap-6 w-full lg:w-2/3">
        ...
        <p className="text-on-surface-variant text-lg md:text-xl leading-relaxed max-w-3xl">
          ¿Tienes una idea innovadora o buscas un desarrollador con pasión por la UI/UX? Estoy disponible para nuevos proyectos y colaboraciones creativas.
        </p>
      </section>
        ...
        <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-5">
              <div className="flex items-center gap-4 group cursor-pointer">
                ...
                <div>
                  ...
                  <span className="text-on-surface font-medium text-sm md:text-base group-hover:text-primary transition-colors">hola@luminadev.studio</span>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <span className="text-on-surface font-medium text-sm md:text-base">Madrid, ES (Remoto)</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-surface-container rounded-3xl p-8 border border-white/5 flex flex-col gap-6 shadow-lg">
            ...
            <div className="flex flex-col gap-3">
              <a href="#" className="flex justify-between items-center px-5 py-4 bg-surface-container-highest rounded-2xl hover:bg-surface-variant transition-colors border border-transparent hover:border-white/5 group">
